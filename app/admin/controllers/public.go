...
import (
	...
	. "work/app/admin/common"
	m "work/app/admin/models"
)
...
func (this *MainController) Index() {
	...
	if userinfo == nil {
		this.Ctx.Redirect(302, beego.AppConfig.String("admin_routers")+beego.AppConfig.String("rbac_auth_gateway"))
	}
	tree := this.GetTree()
	if this.IsAjax() {
		this.Data["json"] = &tree
...
func (this *MainController) Login() {
	...
	userinfo := this.GetSession("userinfo")
	if userinfo != nil {
		this.Ctx.Redirect(302, beego.AppConfig.String("admin_routers")+"/public/index")
	}
...
func (this *MainController) Logout() {
	...
	this.Ctx.Redirect(302, beego.AppConfig.String("admin_routers")+"/public/login")
